...
points = [[0.0, -0.4], [0.0, -0.1], [-0.38, -0.25], [-0.38, -0.4], [0.0, -0.1], [0.35, -0.25], [0.35, -0.4], [0.0, -0.1]]
...
def joy_cb(msg: Joy):
    ...
    pose_stamps = [PoseStamped(pose=Pose(position=Point(x=point[0], y=point[1], z=0), orientation=Quaternion(x=0, y=0, z=0, w=1))) for point in points]
