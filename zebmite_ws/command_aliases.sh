...
alias crossbuild='~/minifrc/Zebramites/zebmite_ws/cross_build.sh'
alias deploy='~/scripts/deploy.sh'
alias hwlaunch='roslaunch minimotor minibot_hardware.launch'
alias killros='~/minifrc/Zebramites/zebmite_ws/kill_ros_.sh'
alias natbuild='~/minifrc/Zebramites/zebmite_ws/native_build.sh'
alias rosjet='source ~/minifrc/Zebramites/zebmite_ws/ROSJetsonMaster.sh'
alias rosstd='source ~/minifrc/Zebramites/zebmite_ws/ROSStandard.sh'
