...
alias crossbuild='~/minifrc/Zebramites2023/zebmite_ws/cross_build.sh'
alias deploy='~/scripts/deploy.sh'
alias hwlaunch='roslaunch minimotor_old minibot_hardware.launch'
alias killros='~/minifrc/Zebramites2023/zebmite_ws/kill_ros_.sh'
alias natbuild='~/minifrc/Zebramites2023/zebmite_ws/native_build.sh'
alias rosjet='source ~/minifrc/Zebramites2023/zebmite_ws/ROSJetsonMaster.sh'
alias rosstd='source ~/minifrc/Zebramites2023/zebmite_ws/ROSStandard.sh'
